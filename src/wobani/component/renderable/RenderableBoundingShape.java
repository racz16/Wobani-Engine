...
public class RenderableBoundingShape implements Invalidatable{
    ...
    /**
     Refreshes the AABB by using the given corner point of the Renderable's bounding box.
    ...
    /**
     Refreshes the AABB by using the specified coordinate of the given corner point of the Renderable's bounding box.
    ...
    /**
     Returns the distance between the origin and the Renderable's furthest vertex. This value is not depends on the
     GameObject's scale (object space), so if you scale the GameObject, this method gives you wrong value. If you want to
     get the scaled value of the furthest vertex distance (what is depends on the GameObject's scale), use the
    ...
    /**
     Returns the distance between the origin and the Renderable's furthest vertex. This value depends on the GameObject's
     scale (world space), so even if you scale the GameObject, this method gives you the right value. If you want to get
     the original value of the furthest vertex distance (what is not depends on the GameObject's scale), use the
     getOriginalRadius method.
     <br>
     Note that if the Component doesn't attached to a GameObject, this method returns the original furthest vertex
     distance.
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(super.toString()).append("\n")
                .append(RenderableBoundingShape.class.getSimpleName()).append("(").append(" radius: ")
                .append(getRealRadius()).append(", AABB min: ").append(getRealAabbMin()).append(", AABB max: ")
                .append(getRealAabbMax()).append(")");
        return res.toString();
    }
