...
public abstract class RenderableComponent<T extends Renderable> extends Component{
    ...
    /**
     ...
     @param castShadow true if the Renderable should cast shadows, false otherwise
     */
    ...
    /**
     ...
     @param receiveShadows true if the Renderable should receive shadows, false otherwise
     */
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(super.toString()).append("\n")
                .append(RenderableComponent.class.getSimpleName()).append("(").append(" faces: ").append(getFaceCount())
                .append(")");
        return res.toString();
    }
