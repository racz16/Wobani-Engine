...
public abstract class BlinnPhongPositionalLightComponent extends BlinnPhongLightComponent{
    ...
    /**
     ...
     <p>
     Attenuation calculated as follows: 1 / (constant + linear * distance + quadratic * distance^2)
    ...
    /**
     Sets the attenuation's constant component to the given value. In the most cases it's one.
     <p>
     Attenuation calculated as follows: 1 / (constant + linear * distance + quadratic * distance^2)
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(super.toString()).append("\n")
                .append(BlinnPhongPositionalLightComponent.class.getSimpleName()).append("(").append("constant: ")
                .append(constant).append(", linear: ").append(linear).append(", quadratic: ").append(quadratic)
                .append(")");
        return res.toString();
    }
