...
public class BlinnPhongDirectionalLightComponent extends BlinnPhongLightComponent{
    ...
    /**
     Initializes a new BlinnPhongDirectionalLightComponent to the given values. All of the parameters's components must
     be min. 0.
    ...
    public boolean isTheMainDirectionalLight(){
        BlinnPhongDirectionalLightComponent light = Scene.getParameters()
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(super.toString()).append("\n")
                .append(BlinnPhongDirectionalLightComponent.class.getSimpleName()).append("(").append(")");
        return res.toString();
    }
