...
/**
 * Represents a tile of the world and manages the positional lights placed in
 * this tile of the world both in CPU and VGA side.
 */
public class BlinnPhongLightSourceTile {
    ...
    /**
     * Signs that all light sources in the tile need to refresh for exmaple
     * because the SSBO's size changed.
     */
    ...
    /**
     * Returns true if the given light shouldn't be in this tile, false
     * otherwise.
     *
     * @param light positional light source
     *
     * @return true if the given light shouldn't be in this tile, false
     *         otherwise
     */
    ...
    /**
     * Extends the SSBO's size if the given light shader index equals to the
     * SSBO's size.
     *
    ...
    /**
     * Sets the given light's shader index to the given value and tile position
     * to this tile's center position.
     *
     * @param light       positional light source
     * @param shaderIndex shader index
     */
    ...
    /**
     * Returns true if the given light should be refreshed in this tile, false
     * otherwise.
     *
     * @param light positional light source
     *
     * @return rue if the given light should be refreshed in this tile, false
     *         otherwise
     */
    ...
    /**
     * Changes the SSBO's size based on how many light sources you would like to
     * store in it.
     *
    ...
    /**
     * Extends the list which contains this tile's lights and the SSBO's size to
     * the given size.
     *
     * @param size size
     */
    ...
    /**
     * Shrinks the list which contains this tile's lights and the SSBO's size to
     * the given size.
     *
     * @param size size
     */
    ...
    /**
     * Returns true if the given positional light source should be in this tile,
     * false otherwise.
     *
     * @param light positional light source
     *
     * @return true if the given positional light source should be in this tile,
     *         false otherwise
     */
    ...
    /**
     * Returns true if this tile contains the given positional light source,
     * false otherwise.
     *
     * @param light positional light source
     *
     * @return true if this tile contains the given positional light source,
     *         false otherwise
     */
    ...
    //
    /**
     * Signs that the lights fill more than half of the SSBO's capacity and
     * don't have to shrink the SSBO in the near future.
     */
    ...
    /**
     * Tries to optimize the tile's SSBO. If more than half of the SSBO is empty
    ...
    /**
     * Tries to optimize the tile's SSBO. If more than half of the SSBO is empty
     * or even the whole SSBO is empty at a time, it'll shrink or even release
     * the SSBO.
     *
     * @param elapsedTimeSinceMoreThanHalfCapacity elapsed time since the SSBO
     *                                             was filled more than half of
     *                                             it's capacity
     */
    ...
    /**
     * Replaces the lights into the first half of the SSBO's memory and than
     * shrinks the SSBO to half memory size.
     */
    ...
    /**
     * Computes the SSBO's first empty light slot in the first half of the
     * SSBO's memory. It returns -1 if all the SSBO's first half memory is
     * filled with light sources.
     *
     * @return the SSBO's first empty light slot in the first half of the SSBO's
     *         memory
     */
    ...
    /**
     * Returns true if the tile and the SSBO are usable, and false if thely're
     * released.
     *
	...
	StringBuilder res = new StringBuilder()
		.append(BlinnPhongLightSourceTile.class.getSimpleName()).append("(")
		.append(", tile center: ").append(tileCenter)
		.append(", count: ").append(slotCount)
		.append(")");
	return res.toString();
    }
