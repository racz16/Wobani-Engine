...
import wobani.resources.splines.*;
...
public class Example1 {
    ...
    private static void createDirectionalLight() {
        ...
        BlinnPhongDirectionalLight bpdl = light.getComponents().getOne(BlinnPhongDirectionalLightComponent.class);
        Parameter<BlinnPhongDirectionalLight> mdl = new ComponentParameter<>(bpdl);
        Scene.getParameters().set(Scene.MAIN_DIRECTIONAL_LIGHT, mdl);
    }
