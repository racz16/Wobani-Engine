...
public abstract class BufferObjectBase implements Resource{
    ...
    /**
     Binds the Buffer to the given binding point. You don't have to bind the Buffer before calling this method (but it's
     not a problem if youe do). Note that this method doesn't bind the Buffer, it binds to a binding point. If you want
     to bind the Buffer, you should call the bind method.
    ...
    /**
     Determines wheter this Buffer is usable. If it returns false, you can't use it for anything.
    ...
    /**
     Removes the Buffer from the VRAM. After you released the Buffer, you can't use it for anything.
     */
    @Override
    public void release(){
    ...
    public String toString(){
        return "Buffer{" + "id=" + id + ", dataSize=" + dataSize + ", resourceId=" + resourceId + '}';
    }
