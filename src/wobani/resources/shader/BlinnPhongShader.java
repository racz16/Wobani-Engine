...
public class BlinnPhongShader extends Shader {
    ...
    public void loadGlobalUniforms() {
        ...
        loadMatrix4("shadowProjectionViewMatrix", RenderingPipeline.getParameters().getValue(RenderingPipeline.SHADOW_PROJECTION_VIEW_MATRIX));
        //others
        ...
        boolean wireframe = RenderingPipeline.getParameters().getValueOrDefault(RenderingPipeline.WIREFRAME_MODE, false);
