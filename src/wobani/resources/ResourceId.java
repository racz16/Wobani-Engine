...
/**
 Id for resources. It has three components: id, paths and index. If you create a dynamic resource (not loaded from file),
 ...
 to more resources (like a model to meshes), the id will be 0, the path will be the file's path and the index will be the
...
public class ResourceId{
    ...
    /**
     ...
     greater than 1. Only dynamic resources (not loaded from a file) get unique id.
    ...
    /**
     ...
     resources like when you load a model and create more than one meshes. In that case each resource get the same path,
    ...
    /**
     ...
     one resource it returns 0. If a file loaded to various resources it returns this resource's index in the file.
