...
/**
 This class provides a left and a right helper point to a control point. It could be helpful for example for Bezier
 curves.
 */
public class SplinePoint{
    ...
    /**
     Sets the left helper point to the given value. It changes the right helper point's position to be symmetric to the
     left.
    ...
    /**
     Sets the right helper point to the given value. It changes the left helper point's position to be symmetric to the
     right.
    ...
    public String toString(){
        return "SplinePoint{" + "point=" + point + ", left=" + left + ", right=" + right + '}';
    }
