...
public class LoadableResourceMetaData{
    ...
    public String toString(){
        return "LoadableResourceMetaData{" + "dataStorePolicy=" + dataStorePolicy + ", state=" + state + ", path=" + paths + ", lastActive=" + lastActive + ", vramTimeLimit=" + vramTimeLimit + ", ramTimeLimit=" + ramTimeLimit + ", dataSize=" + dataSize + '}';
    }
