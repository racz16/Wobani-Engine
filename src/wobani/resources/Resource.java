...
public interface Resource{
    ...
    /**
     Returns the resource's data size in action (this means the VRAM or the sound system).
    ...
    /**
     Determines wheter this resource is usable. If it returns false, you can't use if for anything.
