...
import wobani.toolbox.EngineInfo.*;
import wobani.toolbox.annotation.*;

/**
 Signs that not the engine caused the error but one of the underlying libraries.
 */
public class NativeException extends RuntimeException{
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(NativeException.class.getSimpleName()).append("(")
                .append(" causing library: ").append(library).append(")");
        return res.toString();
    }
