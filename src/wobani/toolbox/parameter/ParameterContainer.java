...
/**
 Contains Parameters for customize for example the Scene or the RenderingPipeline.
...
public class ParameterContainer{
    ...
    /**
     Returns the specified Parameter's stored value if it exists, the given default value otherwise.

     @param key          the Parameter's key
     @param <T>          type of the Parameter's stored value
     @param defaultValue default value if the Parameter doesn't exist

     @return the specified Parameter's stored value if it exists, the given default value otherwise
     */
    @Nullable
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(ParameterContainer.class.getSimpleName()).append("(")
                .append(" number of Parameters (including nulls): ").append(size()).append(")");
        return res.toString();
    }
    ...
    private class ParameterContainerMap<S>{
        ...
        /**
         Calls the add and remove callbacks on the given Parameters, so that they can react to the changes.
        ...
        @Override
        public String toString(){
            StringBuilder res = new StringBuilder().append("ParameterContainerMap(")
                    .append(" number of Parameters (including nulls): ").append(size()).append(")");
            return res.toString();
        }
