...
/**
 The key of a Parameter. It consists of two parts: the key and the return type. This two identifies a Parameter, not only
 the String key. The return type makes the ParameterContainer type safe.
...
public class ParameterKey<T>{
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(ParameterKey.class.getSimpleName()).append("(")
                .append(" return type: ").append(returnType).append(", key: ").append(key).append(")");
        return res.toString();
    }
