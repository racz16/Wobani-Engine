...
/**
 A Parameter stores some kind of a data. With Parameters you can customize the engine's work. For example you can specify
 the main camera, directional light, audio listener, skybox, gamma value, msaa value etc. Of course you can create your
 own Parameter and use as you want.
...
public class Parameter<T>{
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(Parameter.class.getSimpleName()).append("(").append(" value: ")
                .append(value).append(")");
        return res.toString();
    }
}
