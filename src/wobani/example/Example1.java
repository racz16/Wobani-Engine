...
public class Example1{
    ...
    private static void createDirectionalLight(){
        ...
        BlinnPhongDirectionalLightComponent bpdl = light.getComponents()
                .getOne(BlinnPhongDirectionalLightComponent.class);
    ...
    private static void createSpotLight(){
        ...
        spotLight.getComponents().add(new Component(){
            ...
            public void update(){
                ...
                BlinnPhongSpotLightComponent slc = getGameObject().getComponents()
                        .getOne(BlinnPhongSpotLightComponent.class);
    ...
    private static void createMusic(){
        ...
        sound.setName("sound");
        sound.getComponents().getOne(MeshComponent.class).getMaterial()
                .setSlot(Material.DIFFUSE, new MaterialSlot(new Vector4f(0, 0, 1, 1)));
