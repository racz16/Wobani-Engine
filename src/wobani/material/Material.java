 ...
 * Rendeers support all types of slots.
 */
public class Material {
    ...
    /**
     * Environtment intensity slot's key. The r channel means the object's
     * color, the g channel means the reflection intensity and the b channel
     * means the refraction intensity.
     */
    ...
    /**
     * Returns the Material's specified slot. You can reach the built-in slots'
     * keys as this Material class's public static variables. Note that not all
     * Rendeers support all types of slots.
     *
    ...
    /**
     * Sets the Material's specified slot to the given value. You can reach the
     * built-in slots' keys as this Material class's public static variables.
     * Note that not all Rendeers support all types of slots.
     *
     * @param key  slot's key
