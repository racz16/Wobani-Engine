...
public class MaterialSlot{
    ...
    /**
     Determines whether the shader use the specular map's or the specular color's alpha channel as a glossiness value.
     */
    public static final ParameterKey<Float> USE_GLOSSINESS = new ParameterKey<>(Float.class, "PARAM_USE_GLOSSINESS");
    /**
     Determines whether the shader use the normal map's alpha channel as a parallax map.
     */
    ...
    /**
     Returns the texture's tile factor. The x coordinate is the tiling along the U direction ad the y coordinate is the
     tiling along the V direction.
    ...
    /**
     Sets the texture's tile factor to the given value. The x coordinate is the tiling along the U direction ad the y
     coordinate is the tiling along the V direction.
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(MaterialSlot.class.getSimpleName()).append("(")
                .append(" active: ").append(active).append(", color: ").append(color).append(", texture: ")
                .append(texture).append(", environment probe: ").append(environmentProbe).append(", texture tile: ")
                .append(textureTile).append(", texture offset: ").append(textureOffset).append(", parameters: ")
