...
public interface MouseEventHandler{
    ...
    /**
     This method is called when the cursor is moved. The callback is provided with the position, in screen coordinates,
    ...
    /**
     ...
     @param button         the mouse button that was pressed or released in (0;8) (where 0 is the left mouse button, 1 is
     the right and 2 is the middle)
    ...
    /**
     ...
     from a mouse wheel or a touchpad scrolling area.
