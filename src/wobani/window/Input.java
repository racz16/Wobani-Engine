...
public class Input{
    ...
    /**
     Removes the given mouse event handler from the list of mouse event handlers.
        ...
        if(mouseButtonCallback == null){
            glfwSetMouseButtonCallback(Window.getId(), mouseButtonCallback = new GLFWMouseButtonCallback(){
                ...
                public void invoke(long window, int button, int action, int mods){
                    for(MouseEventHandler eventHandler : mouseEventHandlers){
                        eventHandler.buttonCallback(button, action == KeyStatus.PRESS
                                .getCode(), isShiftPressed(mods), isControlPressed(mods), isAltPressed(mods), isSuperPressed(mods));
                    }
                }
            });
        }
    ...
    /**
     Returns the position of the cursor, in screen coordinates, relative to the upper-left corner of the client area of
     the window.
    ...
    /**
     Sets the position, in screen coordinates, of the cursor relative to the upper-left corner of the client area of the
     window.
    ...
    /**
     Removes the given keyboard event handler from the list of keyboard event handlers.
    ...
    /**
     Returns the last state reported for the specified key. It deals with physical keys, with key tokens named after
     their use on the standard US keyboard layout. If you want to input text, add a KeyboardEventListener and override
     the charCallback or the charModsCallback method.
    ...
    /**
     Removes the given joystick event handler from the list of joystick event handlers.
    ...
    /**
     Removes the specified joystick event handler from the list of joystick event handlers.
    ...
    /**
     Returns the specified joystick. If there is no connected joystick in the given slot, it returns null.
