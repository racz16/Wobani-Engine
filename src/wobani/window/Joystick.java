...
public class Joystick{
     ...
     */
    private final JoystickAxe[] axes = {JoystickAxe.LEFT_STICK_HORIZONTAL, JoystickAxe.LEFT_STICK_VERTICAL, JoystickAxe.TRIGGERS, JoystickAxe.RIGHT_STICK_HORIZONTAL, JoystickAxe.RIGHT_STICK_VERTICAL};
    /**
     Joystick's button configuration.
     */
    private final JoystickButton[] buttons = {JoystickButton.DOWN, JoystickButton.RIGHT, JoystickButton.LEFT, JoystickButton.UP, JoystickButton.LEFT_SHOULDER, JoystickButton.RIGHT_SHOULDER, JoystickButton.BACK, JoystickButton.START, JoystickButton.LEFT_STICK, JoystickButton.RIGHT_STICK, JoystickButton.UP_D_PAD, JoystickButton.RIGHT_D_PAD, JoystickButton.DOWN_D_PAD, JoystickButton.LEFT_D_PAD};
    ...
    /**
     Swaps the two specified axes. It may be helpful if the default configuration already swapped these axes.
    ...
    /**
     Swaps the two specified buttons. It may be helpful if the default configuration already swapped these buttons.
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(Joystick.class.getSimpleName()).append("(").append(" name: ")
                .append(name).append(", axes: ").append(Arrays.toString(axes)).append(", buttons: ")
                .append(Arrays.toString(buttons)).append(", slot: ").append(slot).append(")");
        return res.toString();
    }
