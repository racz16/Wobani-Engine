...
public class WindowParameters{
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(WindowParameters.class.getSimpleName()).append("(")
                .append(" resizable: ").append(resizable).append(", visible at start: ").append(visibleAtStart)
                .append(", decorated: ").append(decorated).append(", focused at start: ").append(focusedAtStart)
                .append(", always on top: ").append(alwaysOnTop).append(", maximized at Start: ")
                .append(maximizedAtStart).append(", title at start: ").append(titleAtStart).append(")");
        return res.toString();
    }
