...
public class RenderableContainer{
    ...
    /**
     Removes the given RenderableComponent from the hierarchy based on the given Renderable and Material. You should call
     this method if the RenderableComponent's Material or Renderable changed and it's not detached from a GameObject.
    ...
    /**
     Refreshes the given RenderableComponent in the hierarchy after the RenderableComponent's Renderable changed.
    ...
    /**
     Refreshes the given RenderableComponent in the hierarchy after the RenderableComponent's Material changed.
    ...
    /**
     Returns the number of RenderableContainer using the given GeometryRenderer and Renderable.

     @param renderer   GeometryRenderer
     @param renderable Renderable

     @return number of RenderableComponent using the given GeometryRenderer and Renderable
     */
    ...
    /**
     Returns the indexth RenderableComponent using the given GeometryRenderer and Renderable.If there is no such
     RenderableComponent, it returns null.

     @param renderer   GeometryRenderer
     @param renderable Renderable
     @param index      index

     @return the indexth RenderableComponent using the given GeometryRenderer and Renderable
     */
    @Nullable
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(RenderableContainer.class.getSimpleName()).append("(");
        for(Class<?> renderer : RENDERABLES.keySet()){
            ...
            for(Renderable renderable : rm.getRenderables()){
                res.append(" ").append(renderable.hashCode()).append("(").append(rm.getList(renderable).size())
                        .append("), ");
            }
            res.append("), ");
        }
    ...
    private class RenderableMap{
        ...
        /**
         ...
         @throws ComponentAttachmentException RenderableComponent already attached to a GameObject
         */
        public void remove(@NotNull RenderableComponent<? extends Renderable> renderableComponent){
            if(renderableComponent.getGameObject() != null){
                throw new ComponentAttachmentException(renderableComponent);
            }
            removeRenderableComponent(renderableComponent, renderableComponent.getRenderable(), renderableComponent
                    .getMaterial());
        }

        /**
         Removes the given RenderableComponent if it's Material or Renderable changed.
        ...
        /**
         ...
         @return a RenderableComponentList based on the given RenderableComponent
         */
        @NotNull
        ...
        /**
         Adds a RenderableComponentList based on the given RenderableComponent.
        ...
        @Override
        public String toString(){
            StringBuilder res = new StringBuilder(RenderableMap.class.getSimpleName()).append("(").append("map: ")
                    .append(map).append(")");
            return res.toString();
        }
    ...
    /**
     Represents a list which contains RenderableContainer using the same Renderable and GeometryRenderer.
     */
    private class RenderableComponentList{
        ...
        /**
         Determines whether the given RenderableComponent is contained by the list.

         @param renderableComponent RenderableComponent

         @return true if the list contains the given RenderableComponent, false otherwise
         */
        ...
        @Override
        public String toString(){
            StringBuilder res = new StringBuilder(RenderableComponentList.class.getSimpleName()).append("(")
