...
public class ComponentLists {
     ...
     * Components attached to GameObjectContainer in the past won't be presented
     * in the new list.
     *
     ...
     * method but Components attached to GameObjectContainer in the past won't
     * be presented in the new lists.
     *
	...
	StringBuilder res = new StringBuilder()
		.append(ComponentLists.class.getSimpleName()).append("(");
