...
/**
 Stores a GameObject's transformation data. It stores the position, the rotation, the scale, both absolute and relative
 values. Also stores the model matrix, the inverse model matrix and the direction vectors. If the GameObject doesn't have
 parent, it's relative and absolute values are the same. All rotation values are stored in degrees.
...
public class Transform implements Invalidatable{
    ...
    /**
     Refreshes the absolute position, the absolute rotation and the absolute scale.
     */
    ...
    /**
     Refreshes the absolute position, rotation and scale when the attached GameObject is a root. In this case the
    ...
    /**
     ...
     @return true if the Transform is attached to a GameObject and this GameObject have a parent, false otherwise
     */
    ...
    /**
     Returns true if the Transform's Invalidatables contains the specified element.

     @param invalidatable Invalidatable

     @return true if this Transform's Invalidatables contains the specified element, false otherwise
     */
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(Transform.class.getSimpleName()).append("(")
                .append(" position: ").append(getAbsolutePosition()).append(", rotation: ")
                .append(getAbsoluteRotation()).append(", scale: ").append(getAbsoluteScale()).append(", forward: ")
                .append(getForwardVector()).append(")");
        return res.toString();
    }
