...
public class GameLoop{
    ...
    /**
     Initializes the engine including the windowing system, the input handling, the rendering pipeline and much more. You
     should call it before any OpenGL or OpenAL related code and before the GameLoop's run method.
    ...
    /**
     Releases all the Resources, the windowing system and the OpenAL. After calling this method you can no longer use
     Meshes, Splines, Textures, sounds, FBOs, the rendering pipeline or the window.
     */
