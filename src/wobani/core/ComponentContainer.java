...
public class ComponentContainer{
    ...
    /**
     ...
     @throws ComponentAttachmentException Component is already attached to a GameObject
     */
    ...
    /**
     Adds the given Component to the GameObject's Components if it's not already in it.
    ...
    /**
     Removes from the GameObject all the Components that's class is the given type or extends it.
    ...
    /**
     Returns one of the GameObject's Components that's class is the given type or extends it.

     @param <T>  type
     @param type type

     @return one of the GameObject's Components that's class is the given type or extends it
    ...
    /**
     Returns a list containing all the GameObject's Components that's class is the given type or extends it. If there's
     no such a Component, it returns an empty list.

     @param <T>  type
     @param type type

     @return a list containing all the GameObject's Components that's class is the given type or extends it
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(ComponentContainer.class.getSimpleName()).append("(")
