...
public class GameObject{
    ...
    /**
     Returns the GameObject's name. If it doesn't have name, the method returns the hash code.
    ...
    /**
     Sets the given parameter to this GameObject's parent. The parameter can't be this, and the descendant of this.

     @param parent parent

     @throws IllegalArgumentException parent can't be this and the descendant of this
     */
    ...
    private TransformHolder getCurrentTransformData(){
        return new TransformHolder(transform.getAbsolutePosition(), transform.getAbsoluteRotation(), transform
                .getAbsoluteScale());
    }
    ...
    /**
     ...
     @throws IllegalArgumentException Transform is already attached to a GameObject
     */
    ...
    public String toString(){
        ...
        StringBuilder res = new StringBuilder().append(GameObject.class.getSimpleName()).append("(").append(" name: ")
                .append(getName()).append(", parent: ").append(parentName).append(",\ntransform: ").append(transform)
                .append(",\nchildren: ").append(getChildren().size()).append(",\ncomponents: ").append(components)
                .append(")");
        return res.toString();
    }
    ...
    private class TransformHolder{
        ...
        @Override
        public String toString(){
            StringBuilder res = new StringBuilder().append(TransformHolder.class.getSimpleName()).append("(")
                    .append(" position: ").append(position).append(", rotation: ").append(rotation).append(", scale: ")
                    .append(scale).append(")");
            return res.toString();
        }
