...
public class ChildContainer{
    ...
    /**
     ...
     @return true if the given parameter is the child of the GameObject, false otherwise
    ...
    /**
     Determines whether the given parameter is the child of the GameObject or the descendant of it.

     @param child child

     @return true if the given parameter is the child of the GameObject or the descendant of it, false otherwise
    ...
    /**
     Returns true if the given parameter is the descendant of the GameObject but not the child of it.
    ...
    /**
     Removes the given GameObject from children. Note that this method doesn't set the child's parent to null, it remains
     the old parent.
    ...
    /**
     Adds the given GameObject to the children. Note that this method doesn't set the child's parent to the gameObject,
     it remains the old parent.
    ...
    public String toString(){
        StringBuilder res = new StringBuilder().append(ChildContainer.class.getSimpleName()).append("(");
