...
/**
 Audio sources can emit sound effect through the connected audio buffer.
 */
public class AudioSource implements Resource{
    ...
    /**
     Sets the audio source's rolloff factor to the given value. It affects the attenuation.
    ...
    /**
     Returns the audio source's reference distance. It affects the attenuation.
    ...
    /**
     Sets the audio source's reference distance to the given value. It affects the attenuation.
    ...
    /**
     Sets the audio source's max distance to the given value. It affects the attenuation.
    ...
    /**
     Returns whether the audio source's position, velocity and direction is relative to the audio listener.

     @return true if the audio source's position, velocity and direction is relative to the audio listener, false if they
     are absolute
     */
    ...
    /**
     Sets whether or not the audio source's position, velocity and direction is relative to the audio listener.

     @param relative the audio source's position, velocity and direction should be relative to the audio listener or not
     */
    ...
    public String toString(){
        return "AudioSource{" + "id=" + id + ", buffer=" + buffer + ", resourceId=" + resourceId + '}';
    }
