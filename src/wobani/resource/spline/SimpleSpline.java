...
/**
 Represents a simple spline. It stores the control points and data you need to render it.
 */
public class SimpleSpline implements Spline{
    ...
    /**
     The number of points stored in the VAO. This is not the number of the control points.
     */
    ...
    /**
     Returns the splie's data based on the control points and the type of the spline. Also computes the AABB and the
     bounding sphere.
    ...
    /**
     Returns the point on the spline between the startIndexth and startIndex+1th controlpoints, specified by the argument
     t. This method returns to null if the spline doesn't contain any points. The startIndex can't be lower than 0 and
     can't be higher than the control point's number -1 (except if it's a loop spline).
    ...
    /**
     Sets whether or not the spline is dynamic. It is advised to set the spline to dynamic if you want to change the
     spline's data frequently.

     @param dynamic true if the spline's data should be dynamic, false otherwise
     */
    ...
    /**
     Returns the number of points stored in the VAO. This is not the number of the control points.
    ...
    /**
     Returns the number of the spline's control points. This is not the same as the number of points stored in the VAO.
    ...
    /**
     Returns the required number of control points. If the spline contains less control points, you can't render the
     spline.
    ...
    public String toString(){
        return "SimpleSpline{" + "controlPoints=" + controlPoints + ", vao=" + vao + ", valid=" + valid + ", lengthValid=" + lengthValid + ", numberOfPoints=" + numberOfPoints + ", loopSpline=" + loopSpline + ", dynamic=" + dynamic + ", aabbMin=" + aabbMin + ", aabbMax=" + aabbMax + ", furthestVertexDistance=" + furthestVertexDistance + ", dataSize=" + dataSize + ", distances=" + distances + ", length=" + length + ", resourceId=" + resourceId + '}';
    }
