...
public interface Spline extends Renderable{
    ...
    /**
     Returns the spline's forward vector at the given t "time", where t=0 means the start of the spline and t=1 means the
     end of the spline.
    ...
    /**
     Returns the spline's approximated position at the given t "time", where t=0 means the start of the spline and t=1
     means the end of the spline.
