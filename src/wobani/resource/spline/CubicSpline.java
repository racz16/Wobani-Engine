...
public abstract class CubicSpline extends SimpleSpline{
    ...
    /**
     Determines the spline's resolution between two control points. The lower the number, the smoother the spline.
     */
    ...
    /**
     Sets the step to the given value. The lower the number, the smoother the spline.

     @param step step

     @throws IllegalArgumentException step must be higher than 0 but it can't be higher than 1
     */
    ...
    public String toString(){
        return super.toString() + "\nCubicSpline{" + "basisMatrix=" + basisMatrix + ", step=" + step + '}';
    }
