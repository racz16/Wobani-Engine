...
public class DynamicTexture2D extends DynamicTexture implements Texture2D{
    ...
    public DynamicTexture2D(@NotNull FboAttachmentSlot attachmentType, @NotNull Vector2i size, boolean floatingPoint, boolean multisampled, int samples, @Nullable ByteBuffer image){
        ...
        if(multisampled){
            ...
            glTexImage(attachmentType.getInternalFormat(floatingPoint), attachmentType.getFormat(), attachmentType
                    .getType(), image);
        }
    ...
    public String toString(){
        return super
                .toString() + "\nDynamicTexture{" + "dataSize=" + dataSize + ", attachmentType=" + attachmentType + ", multisampled=" + multisampled + ", samples=" + samples + ", resourceId=" + resourceId + '}';
    }
