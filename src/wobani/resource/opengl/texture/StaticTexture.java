...
import wobani.resource.DataStoreManager;
...
import static wobani.resource.opengl.texture.EasyFiltering.TextureFiltering.TRILINEAR;
...
public abstract class StaticTexture extends AbstractTexture implements EasyFiltering, ChangableColorSpace {
    ...
    public StaticTexture(ResourceId resourceId) {
        super(resourceId);
    }
    ...
    protected void changeFiltering() {
        getTexture().generateMipmaps();
        switch (filtering) {
            case NONE:
                getTexture().setFilter(TextureFilterType.MAGNIFICATION, TextureFilter.NEAREST);
                getTexture().setFilter(TextureFilterType.MINIFICATION, TextureFilter.NEAREST_MIPMAP_NEAREST);
                break;
            case BILINEAR:
                getTexture().setFilter(TextureFilterType.MAGNIFICATION, TextureFilter.LINEAR);
                getTexture().setFilter(TextureFilterType.MINIFICATION, TextureFilter.LINEAR_MIPMAP_NEAREST);
                break;
            case TRILINEAR:
                getTexture().setFilter(TextureFilterType.MAGNIFICATION, TextureFilter.LINEAR);
                getTexture().setFilter(TextureFilterType.MINIFICATION, TextureFilter.LINEAR_MIPMAP_LINEAR);
                break;
            default:
                getTexture().setFilter(TextureFilterType.MAGNIFICATION, TextureFilter.LINEAR);
                getTexture().setFilter(TextureFilterType.MINIFICATION, TextureFilter.LINEAR_MIPMAP_LINEAR);
