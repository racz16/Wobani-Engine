...
public class GameObjectChildren {
     ...
     */
    public GameObjectChildren(@NotNull GameObject gameObject) {
        if (gameObject == null) {
    ...
    public boolean equals(Object obj) {
        ...
        final GameObjectChildren other = (GameObjectChildren) obj;
    ...
    public String toString() {
        return "GameObjectChildren{" + "children=" + children + ", gameObject="
                + gameObject.getName() + '}';
    }
