 ...
 * Camera interface, you have to call the addToTrackedTypes method and pass
 * Camera.class. After that you can get all Components which implement the
 * Camera interface and attached to a GameObject by calling the getComponent
 * method. If a Component implements two or more tracked interfaces, it'll be
 * stored in all appropirate slots.
 */
public class ComponentLists {
    ...
    /**
     * Adds the given type to the tracked types. After calling this method, all
     * Components that instances of the given type, and you attached to a
     * GameObject will be presented in the appropirate lists. Note that
     * Components attached to GameObjects in the past won't be presented in the
     * new list.
     *
    ...
    /**
     * Removes the given type and the correspondig list from the tracked
     * Components. After calling this method, Components that instances the
     * given type, and you attached to a GameObject no more will be presented in
     * the appropirate list.
     *
    ...
    /**
     * Adds the given Component to the appropirate lists. Note that if the given
     * Component is instace of more list's types, it'll be presented in and only
     * in these lists. You can add more types by calling the addToTrackedTypes
     * method but Components attached to GameObjects in the past won't be
     * presented in the new lists.
     *
    ...
    /**
     * Returns the number of Components implements the given type and attached
     * to a GameObject.
     *
     * @param <T>  type
     * @param type type
     *
     * @return number of Components implements the given type and attached to a
     *         GameObject
     */
    ...
    /**
     * Returns the indexth Component which implements the given type and
     * attached to a GameObject. Note, that this only works if the appropirate
     * type is tracked. You can track types by calling the addToTrackedTypes
     * method.
     *
     * @param <T>   type
     * @param type  type
     ...
     *
     * @return the indexth Component which implements the given type and
    ...
    /**
     * Refreshes all the tracked types' lists. It can be useful when you added a
     * new tracked type, and you want to fill this type's list with the
    ...
    private void refreshGameObjectComponents(@NotNull GameObject object) {
        GameObjectComponents components = object.getComponents();
    ...
    public String toString() {
        return "ComponentLists{" + "lists=" + lists + '}';
    }
