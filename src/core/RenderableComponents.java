...
/**
 * Stores all the RenderableComponents.
 */
public class RenderableComponents {

    /**
     * Contains all the RenderableComponents.
     */
    ...
    /**
     * Returns the number of RenderableComponents using the given
    ...
    /**
     * The RenderableMap contains RenderableComponents grouped by Renderables.
     */
    private class RenderableMap {

        /**
         * Contains RenderableComponents grouped by Renderables.
         */
         ...
         * @param renderableComponent RenderableComponent you want to add
         *
         * @throws AttachmentException renderableComponent have to be attached
         *                             to a GameObject
         */
        public void add(@NotNull RenderableComponent<? extends Renderable> renderableComponent) {
            if (renderableComponent.getGameObject() == null) {
                throw new AttachmentException(null, renderableComponent);
            }
         ...
         *
         * @throws AttachmentException renderableComponent have to detached from
         *                             a GameObject
         */
        public void remove(@NotNull RenderableComponent<? extends Renderable> renderableComponent) {
            if (renderableComponent.getGameObject() != null) {
                throw new AttachmentException(renderableComponent.getGameObject(), renderableComponent);
            }
        ...
        public String toString() {
            return "RenderableMap{" + "map=" + map + '}';
        }

    }

    /**
     * Represents a list which contains RenderableComponents using the same
     * Renderable and GeometryRenderer.
     */
    private class RenderableComponentList {

        /**
         * List of RenderableComponents.
         */
        ...
        /**
         * Returns the number of RenderableComponents in the list.
         *
         * @return the number of RenderableComponents in the list
         */
        public int size() {
            return list.size();
        }
        ...
        @Override
        public String toString() {
            return "RenderableComponentList{" + "list=" + list + '}';
        }
    ...
    public boolean equals(Object obj) {
        ...
        final RenderableComponents other = (RenderableComponents) obj;
    ...
    @Override
    public String toString() {
        return "Renderables{" + "RENDERABLES=" + RENDERABLES + '}';
    }
